...
public:
	...
	//typedef std::map<TFields, int64_t>	TSSet;
	struct TSSetValue
	{
		TKey key;
		int64_t score = 0;
	...
	// 	void SetErrorCall(std::function<void(int err, std::string strmsg)> kFunc)
	// 	{
	// 		_funcErrCall = pFunc;
	// 	}
